...
{
    private async void OnExportSheetSummaryCsvClick(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
    ...
    private async void OnExportPanelsCsvClick(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
